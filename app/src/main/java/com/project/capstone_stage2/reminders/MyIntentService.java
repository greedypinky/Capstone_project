...
public class MyIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "com.project.capstone_stage2.reminders.action.FOO";
    private static final String ACTION_BAZ = "com.project.capstone_stage2.reminders.action.BAZ";
